...
- Once you are ready to end the loop (end of final turn, after conclusion, etc.) you MUST append the exact string token "__CONCLUDE__" to signal to the orchestrator that you are completely finished. If you are in the middle of executing steps and plan to run more tools in the next turn, do NOT output the "__CONCLUDE__" token.
`;
